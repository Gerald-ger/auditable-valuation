...
[![1048 offline tests](https://img.shields.io/badge/tests-1048%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1048 offline, and what they are for |
...
**1048 of those run offline**, against eight companies' real financial statements committed to
this repo — 808 backend, 240 frontend, seconds. 27 more are `network`-marked and deselected by
