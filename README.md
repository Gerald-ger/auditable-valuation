...
[![962 offline tests](https://img.shields.io/badge/tests-962%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 962 offline, and what they are for |
...
**962 of those run offline**, against eight companies' real financial statements committed to
this repo — 762 backend, 200 frontend, seconds. 27 more are `network`-marked and deselected by
...
- `backend/tests/fixtures/` — captured Yahoo Finance responses for ten symbols, kept because
  the 762-test suite runs entirely offline against them. Provenance and capture dates in
