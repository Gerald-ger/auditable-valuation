...
[![1053 offline tests](https://img.shields.io/badge/tests-1053%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1053 offline, and what they are for |
...
**1053 of those run offline**, against eight companies' real financial statements committed to
this repo — 809 backend, 244 frontend, seconds. 27 more are `network`-marked and deselected by
