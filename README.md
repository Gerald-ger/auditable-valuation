...
[![985 offline tests](https://img.shields.io/badge/tests-985%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 985 offline, and what they are for |
...
**985 of those run offline**, against eight companies' real financial statements committed to
this repo — 779 backend, 206 frontend, seconds. 27 more are `network`-marked and deselected by
