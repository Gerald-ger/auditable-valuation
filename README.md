...
[![1009 offline tests](https://img.shields.io/badge/tests-1009%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1009 offline, and what they are for |
...
this repo — 794 backend, 215 frontend, seconds. 27 more are `network`-marked and deselected by
...
- `backend/tests/fixtures/` — captured Yahoo Finance responses for ten symbols, kept because
  the 794-test suite runs entirely offline against them. Provenance and capture dates in
