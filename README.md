...
[![904 offline tests](https://img.shields.io/badge/tests-904%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 904 offline, and what they are for |
...
**904 of those run offline**, against eight companies' real financial statements committed to
this repo — 714 backend, 190 frontend, seconds. 27 more are `network`-marked and deselected by
...
- `backend/tests/fixtures/` — captured Yahoo Finance responses for ten symbols, kept because
  the 714-test suite runs entirely offline against them. Provenance and capture dates in
