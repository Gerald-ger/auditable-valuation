...
[![1033 offline tests](https://img.shields.io/badge/tests-1033%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1033 offline, and what they are for |
...
cd frontend; npm test                                   # 233 tests
```

**1033 of those run offline**, against eight companies' real financial statements committed to
this repo — 800 backend, 233 frontend, seconds. 27 more are `network`-marked and deselected by
