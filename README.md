...
[![882 offline tests](https://img.shields.io/badge/tests-882%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 882 offline, and what they are for |
...
**882 of those run offline**, against eight companies' real financial statements committed to
this repo — 693 backend, 189 frontend, seconds. 27 more are `network`-marked and deselected by
...
- `backend/tests/fixtures/` — captured Yahoo Finance responses for ten symbols, kept because
  the 693-test suite runs entirely offline against them. Provenance and capture dates in
