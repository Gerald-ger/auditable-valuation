...
[![1058 offline tests](https://img.shields.io/badge/tests-1058%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1058 offline, and what they are for |
...
cd frontend; npm test                                   # 249 tests
```

**1058 of those run offline**, against eight companies' real financial statements committed to
this repo — 809 backend, 249 frontend, seconds. 27 more are `network`-marked and deselected by
