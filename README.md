...
[![1061 offline tests](https://img.shields.io/badge/tests-1061%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1061 offline, and what they are for |
...
cd frontend; npm test                                   # 252 tests
```

**1061 of those run offline**, against eight companies' real financial statements committed to
this repo — 809 backend, 252 frontend, seconds. 27 more are `network`-marked and deselected by
