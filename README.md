...
[![1056 offline tests](https://img.shields.io/badge/tests-1056%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1056 offline, and what they are for |
...
cd frontend; npm test                                   # 247 tests
```

**1056 of those run offline**, against eight companies' real financial statements committed to
this repo — 809 backend, 247 frontend, seconds. 27 more are `network`-marked and deselected by
