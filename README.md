...
[![1037 offline tests](https://img.shields.io/badge/tests-1037%20offline-brightgreen.svg)](#tests)
...
| [Tests](#tests) | 1037 offline, and what they are for |
...
cd frontend; npm test                                   # 237 tests
```

**1037 of those run offline**, against eight companies' real financial statements committed to
this repo — 800 backend, 237 frontend, seconds. 27 more are `network`-marked and deselected by
